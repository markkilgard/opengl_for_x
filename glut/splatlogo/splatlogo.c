...
/* From logo.c containing the data for an OpenGL logo image. */
extern int logo_width;  /* = 317 */
extern int logo_height; /* = 85 */
...
main(int argc, char *argv[])
{
  ...
  redMenu = scaleBiasMenu(0 << 4);
  greenMenu = scaleBiasMenu(1 << 4);
  blueMenu = scaleBiasMenu(2 << 4);
